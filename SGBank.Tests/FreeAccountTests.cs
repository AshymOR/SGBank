...
namespace SGBank.Tests
{
    ...
    public class FreeAccountTests
    {
        ...
        [TestCase("12345", "Free Account", 100, AccountType.Free, 50, false)] //Positive withdrawal
        [TestCase("12345", "Free Account", 500, AccountType.Free, -500, false)]  //Withdrawing too much
        [TestCase("12345", "Free Account", 100, AccountType.Basic, -50, false)] // Wrong account type
        [TestCase("12345", "Free Account", 25, AccountType.Basic, -50, false)] //Overdraft
